...
uniquePrey19%>%
  ...
  geom_text(data=min,aes(2005,2010,label=paste0("Min=",min,": ",minyearseason)),size=7)+
...
s<-prey19%>%
  ...
  scale_fill_manual(values=rainbow_hcl(9,c=100,l=60))+
  scale_color_manual(values=rainbow_hcl(9,c=100,l=60))+
  theme(legend.position = "none",axis.title.y=element_blank(),axis.text.y=element_blank(),axis.title.x=element_text(size=40))+
